...
namespace DATA_C_
{
    public partial class Sanitary_control : Form
    {
        public Sanitary_control()
        {
            InitializeComponent();
        }
        ...
        private void Sanitary_control_Load(object sender, EventArgs e)
        {
            ...
            if (conn != null)
            {
                ...
                string query = "SELECT * FROM Sanitary_control";
